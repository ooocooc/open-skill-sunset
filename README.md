...
The screenshot comes from a real report generated by the current CLI from `test/fixtures/sample-setup`: 5 files scanned, 11 findings, with duplicate retirement, stale-reference updates, progressive disclosure, and behavior hypotheses shown separately. [Open the animated walkthrough](https://raw.githubusercontent.com/ooocooc/open-skill-sunset/main/docs/assets/skill-sunset-demo.gif).
